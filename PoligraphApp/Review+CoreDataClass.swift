...
public class Review: NSManagedObject {
    ...
    */
    class func addNewReview(feedbackText: String, recommendation: Int, biasRating: Double, question: Question, reviewer: User, inManagedObjectContext context: NSManagedObjectContext) -> Review? {
